...
namespace KPMG.Pulse.Back.Accounting.Mandate.Adapters.Tests
{
    public class SqlExtensionsTest
    {
        ...
        public void Status_ToModel()
        {
            ...
            result.Should().BeEquivalentTo(new Status(CollectionStatus.InProgress, "statusName", Mandate.JdcCollectionStatus.Incident, null));
        }
        ...
        public void ToStatusesDB()
        {
            ...
            Status status = new Status(CollectionStatus.ToDo, "En cours", Mandate.JdcCollectionStatus.Creation_InProgress, null);
