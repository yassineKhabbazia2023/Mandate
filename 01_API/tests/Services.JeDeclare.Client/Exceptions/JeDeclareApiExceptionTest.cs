// <copyright file="JeDeclareApiExceptionTest.cs" company="KPMG">
// Copyright (c) KPMG. All rights reserved.
// </copyright>

namespace KPMG.Pulse.Back.Accounting.Mandate.JeDeclare.Client.Tests;

public class JeDeclareApiExceptionTest
{
    [Fact]
    public void DefaultConstructor_ShouldInstantiateWithDefaultMessage()
    {
        // Act
        var exception = new JeDeclareApiException();

        // Assert
        exception.Message.Should().Be("Exception of type 'KPMG.Pulse.Back.Accounting.Mandate.JeDeclare.Client.JeDeclareApiException' was thrown.");
    }
    ...
    public void ConstructorWithMessage_ShouldSetMessage()
    {
        ...
        // Act
        var exception = new JeDeclareApiException(customMessage);
